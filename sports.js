...
xhr.open('GET', `https://newsapi.org/v2/top-headlines?category=sports&language=en&apiKey=${apiKey}&pageSize=50`, true);
...
xhr2.open('GET', `https://newsapi.org/v2/top-headlines?category=sports&language=en&apiKey=${apiKey2}&pageSize=50&page=2`, true);
    ...
    xhr.onload = function () {
        if (this.status === 200) {
            ...
            if (articles.length == 0)
                ...
                document.getElementById("heading").innerHTML = `Sports News of ${document.getElementById(search_value2).innerHTML}`
            document.getElementById("loader_container").style.display = "none"
            document.getElementById("loader_container").style.visibility = "hidden"
            // console.log(articles[0].content);
            articles.forEach(function (element, index) {
